...
## OpenCode behavior
- [ ] I verified the plugin still injects the `using-superpowers` bootstrap
- [ ] I verified the bundled skills are discoverable through OpenCode's `skill` tool
- [ ] I verified recommended `superpowers-orchestrator` / `sp-*` agents are registered or intentionally unaffected
